...
type RegionRepository interface {
	...
	FindByID(ctx context.Context, id int32) (*models.Region, error)
	...
	FindByIDWithCountry(ctx context.Context, id int32) (*models.Region, error)
}
...
func (r *regionRepository) FindByIDWithCountry(ctx context.Context, id int32) (*models.Region, error) {
	//1. using value slice
...
func (r *regionRepository) FindByID(ctx context.Context, id int32) (*models.Region, error) {
