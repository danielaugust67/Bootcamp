...
type RegionService interface {
	...
	GetRegionByID(ctx context.Context, id int32) (*models.Region, error)
	...
	GetRegionByIDWithCountry(ctx context.Context, id int32) (*models.Region, error)
}
...
func (s *regionService) GetRegionByIDWithCountry(ctx context.Context, id int32) (*models.Region, error) {
	if id == 0 {
...
func (s *regionService) GetRegionByID(ctx context.Context, id int32) (*models.Region, error) {
	if id == 0 {
		return nil, errors.New("region ID cannot be empty")
	}
...
func (s *regionService) DeleteRegion(ctx context.Context, id int32) error {
	if id == 0 {
		return errors.New("region ID cannot be empty")
	}
